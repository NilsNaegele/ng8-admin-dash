...
import { PieChartComponent as BasePieChartComponent } from '../../../../theme/components/pie-chart/pie-chart.component';

import { BrowserStatisticsService } from './browser-statistics.service';

@Component({
  selector: 'app-browser-statistics',
  templateUrl: './browser-statistics.component.html',
  styleUrls: ['../../../../theme/components/pie-chart/pie-chart.component.scss'],
})
export class BrowserStatisticsComponent extends BasePieChartComponent  implements OnInit {
  constructor(
  ...
  public ngOnInit() {
    ...
    if (container1[0][0]) {
      ...
      const data = this.browserStatisticsService.getBrowserStatistics();

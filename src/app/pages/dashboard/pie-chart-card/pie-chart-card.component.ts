...
import { PieChartService } from './pie-chart-card.service';
...
export class PieChartCardComponent extends BasePieChartComponent implements OnInit {
  constructor(
    ...
    nv.addGraph(() => {
      ...
      pieChart.tooltip.enabled(true)
        ...
        .contentGenerator((d) => {
          ...
          if (d.data !== undefined) {
            return `${d.data.key} ${d.data.y} Stunden`;
          }
        });
